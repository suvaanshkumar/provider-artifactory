...
PROJECT_REPO ?= github.com/exampleorg/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_REPO ?= https://github.com/jfrog/terraform-provider-artifactory.git
export TERRAFORM_PROVIDER_VERSION ?= 12.0.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= jfrog/artifactory
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-artifactory_v12.0.0
